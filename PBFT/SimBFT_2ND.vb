...
Public Function CSrcNode(ByVal input As String) As Node
    return New Node(input, UNKNOWN)
End Function
...
Public Class Process
    ...
    Private Shared mTraits As New Traits
    ...
    Sub New(ByVal id As Integer, ByVal source As Integer, ByVal m As Integer, ByVal n As Integer, ByVal srcval As Node)
        ...
        If mTraits Is Nothing Then
            mTraits = Traits(source, m, n, srcval)
        End If
...
Public Sub SimBFT(ByVal source As Integer, ByVal m As Integer, ByVal n As Integer, ByVal srcval As Node)
    Dim processes As New List(Of Process)
    For i As Integer = 0 To N - 1
        Dim tmp_process As New Process(i, source, m, n, srcval)
